...
(<https://www.unicode.org/license.txt>). The pre-tokenizers in
`inference/src/tokenizer/pre.zig` (`qwen35`) and
`inference/src/tokenizer/gpt4o.zig` (`llama4`) implement the splitting rules
declared by the models' tokenizers; both are independently written.
